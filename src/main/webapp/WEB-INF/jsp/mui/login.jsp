...
<script src="../MUI/js/pintuer.js"></script>
</head>
<body>
	<shiro:authenticated>
		<script>window.location.href='index.do';</script>
	</shiro:authenticated>
	<div class="bg"></div>
	<div class="container">
				...
				<form action="login.do" method="post">
					<div class="panel loginbox">
                        ...
                        <div class="field">
                           ...
                           <img src="MUI/images/passcode.jpg" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'">  
